...
public:
  ...
  struct guiformat GetGuiFormat() const { return m_gui_format; }
  uint64_t GetGuiModifier() const { return m_gui_modifier; }
...
private:
  ...
  struct guiformat m_gui_format{DRM_FORMAT_INVALID, 0, 0, false, {}};
  uint64_t m_gui_modifier{DRM_FORMAT_MOD_INVALID};
